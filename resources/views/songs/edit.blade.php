                ...
                <div class="card shadow p-4">
                    ...
                    <form method="POST" action="{{route('songs.update' , $song)}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="form-control" id="name" value="{{ old('name', $song->name) }}">
                        </div>

                        <div class="mb-3">
                            <label for="artist" class="form-label">Artista</label>
                            <input name="artist" type="text" class="form-control" id="artist" value="{{  old('artist' , $song->artist )  }}">
                        </div>

                        <div class="mb-3">
                            <label for="album" class="form-label">Album</label>
                            <input name="album" type="text" class="form-control" id="album" value="{{  old('album' , $song->album )  }}"  >
                        </div>
